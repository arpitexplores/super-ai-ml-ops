...
5. Rename the extracted folder from `super-ai-ml-ops-main` to `super-ai-ml-ops`.
6. Copy the renamed `super-ai-ml-ops` folder into your agent's skills directory.
...
This repository is the `super-ai-ml-ops` skill. Keep the full `super-ai-ml-ops` folder together when installing it.
